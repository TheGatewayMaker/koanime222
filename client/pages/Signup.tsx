        ...
        <div className="mx-auto w-full max-w-md rounded-xl border p-6 shadow-sm">
          ...
          <form className="mt-6 space-y-3">
            <div>
              ...
              <input className="mt-1 w-full rounded-md border bg-background px-3 py-2" placeholder="Your name" />
            </div>
            <div>
            ...
            <button type="submit" className="mt-2 w-full rounded-md bg-primary px-3 py-2 font-semibold text-primary-foreground">Sign up</button>
          </form>
